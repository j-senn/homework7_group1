 ...
 *
 * Parameters:
 *   outstring - string to be outputted
 *   first_stream - the first stream to which the string will 
 *                  be printed
 *   second_stream - the second stream to which the string will 
 *                   be printed
**/
void Utils::Output(std::string outstring, std::ofstream& first_stream,
                   std::ofstream& second_stream) {
  first_stream << outstring;
  second_stream << outstring;
}
